...
function Signup() {
  ...
  return (
    ...
    <div className="className='mx-auto w-full max-w-lg bg-gradient-to-r from-gray-800 via-gray-900 to-black backdrop-blur-lg rounded-xl p-10 border border-gray-700">
    <div className="mb-2 flex justify-center">
        ...
        <form onSubmit={handleSubmit(createAcnt)}>
