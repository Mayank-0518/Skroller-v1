...
function Footer() {
  return (
    <section className="relative  overflow-hidden py-12 bg-gradient-to-r from-gray-800 via-gray-900 to-black border-t-2 border-gray-700 backdrop-blur-lg bg-opacity-50">
